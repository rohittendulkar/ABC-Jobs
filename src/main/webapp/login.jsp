...
<body>
	...
	<div style='z-index: 2;width:25rem' class="card border-primary mb-3 align-items-center">
		<s:form cssClass="well form-horizontal" action="loginprocess" method="post" id="contact_form" theme="simple">
			<fieldset>
				<!-- Form Name -->
				<legend>
					<center>
				...
				<s:actionmessage class="text-danger"/>
				<br>
				...
				<div class="form-group">
				<a href="forgetpass" class="text-secondary">Forgot Password?</a>
				</div>
				<div class="form-group">
